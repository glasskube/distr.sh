...
With the recent [introduction of our container registry](/glossary/oci-container-artifact-registry/) we are now also supporting
...
[Kubernetes Metrics Collection](/glossary/kubernetes/) in our documentation.
