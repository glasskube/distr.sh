...
description: With Distr you can define environment variable templates for deploying Docker applications. Tip: With docker compose you can reference variables in multiple services.
sidebar:
  order: 4
---
