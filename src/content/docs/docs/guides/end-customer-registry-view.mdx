...
<Aside type="note">
  The registry is used directly by [Fully Self-Managed customers](/docs/use-cases/fully-self-managed/) and indirectly by the other deployment models, as Distr agents may need to fetch container images stored in the registry.
</Aside>
