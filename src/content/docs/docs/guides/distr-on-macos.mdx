...
If you're using Windows or Linux, the [Quickstart guide](/docs/quickstart/) should cover everything you need. But if you're setting up Distr on macOS, follow these steps to ensure a smooth deployment experience.
