...
<Aside type="note">
  Air-gapped deployments require special consideration and often custom solutions. Contact our team for personalized assistance with implementing this model.
</Aside>
...
<Aside type="tip">
  Consider creating a dedicated security procedures document specifically for your air-gapped customers.
</Aside>
