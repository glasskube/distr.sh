...
<Aside type="tip">
  ...
  [application license](/docs/guides/customer-management/application-licenses/) and assign it to the
  customer first
</Aside>
...
For more information on how to use them, please refer to [our guide on working with environment variables](/docs/guides/configuration/docker-env-var-template/).
...
- [Application Licenses](/docs/guides/customer-management/application-licenses/) - Control which applications customers can access
- [Docker Environment Variables](/docs/guides/configuration/docker-env-var-template/) - Configure environment variable templates
- [Helm Chart Registry Auth](/docs/guides/configuration/helm-chart-registry-auth/) - Set up authenticated image pulls
