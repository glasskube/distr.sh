...
Nowadays, most software is designed to run in a single cloud environment that vendors fully control, connected to internal container registries insisde the cloud provider, deployment pipelines, and observability tools.
