...
Nowadays, most software is designed to run in a single cloud environment that vendors fully control, connected to various first-party container registries, deployment pipelines, and observability tools.
