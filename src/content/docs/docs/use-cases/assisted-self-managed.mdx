...
<Aside type="tip">
  The agent acts only as a facilitator, pulling updates and applying them according to customer-defined policies. It does not provide vendor access to customer infrastructure.
</Aside>
