...
<Steps>
  ...
  2. **(Optional) Set Up Your [Registry](/docs/guides/how-to-registry/)** 
  ...
  6. **Customer can [deploy your application via the Dist [agents](/docs/guides/end-customer-registry-view/#deployment-agent-quickstart-from-the-customer-portal)**
</Steps>
