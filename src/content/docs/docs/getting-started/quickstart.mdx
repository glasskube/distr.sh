...
This tutorial guides you through setting up your [Customer Portal](/docs/product/distr-hub/#what-customers-can-do-in-the-customer-portal) and inviting a customer. You'll learn how to customize the portal name and welcome page with helpful instructions and release notes, send the customer invite email, and preview the portal from the end customer's perspective.
...
2. **Push Your Commercial Artifacts:** Upload your artifacts to your private [registry](/docs/product/registry/)
