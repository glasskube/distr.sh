...
- For more information on how to deploy a Docker compose packaged application, check out this [guide](https://glasskube.dev/products/cloud/docs/guides/onboarding-a-docker-app/).
- For more information on how to deploy a Helm chart packaged application, check out this [guide](https://glasskube.dev/products/cloud/docs/guides/onboard-helm-app/).
