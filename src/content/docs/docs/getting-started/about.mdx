...
Distr provides distribution tooling for [self-managed](/docs/use-cases/fully-self-managed/asdf/as), [BYOC](/docs/use-cases/byoc/), [air-gapped](/docs/use-cases/air-gapped/),
