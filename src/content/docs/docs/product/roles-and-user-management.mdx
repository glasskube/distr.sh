...
<Aside type="note">
  Role-based access control is available in Pro, Enterprise, and Pro Trial plans. The Starter plan only allows one user per customer who will automatically have Administrator privileges. All internal users have Administrator privileges as well.
</Aside>
...
| Permission | Administrator | User | Viewer |
|-----------|---------------|------|--------|
| **View Dashboard** | ✅ | ✅ | ✅ |
...
<Aside type="tip">
  Customer organization administrators can manage users within their own organization, but vendor administrators have full visibility and control over all customer organizations.
</Aside>
...
<Aside type="note">
  In Starter plans, all users are automatically assigned the Administrator role, and the role selection dropdown is not available.
</Aside>
...
5. Click **Invite User**
6. Enter the user's name and email address and select the role.
7. Click **Submit**
...
<Aside type="caution">
  If you upgrade from Starter to Pro, existing users will automatically be assigned the Administrator role. You can then change their roles as needed.
</Aside>
