...
Follow the configuration steps in the [Deployment Agent Quickstart Guide](/docs/guides/end-customer-registry-view/#deployment-agent-quickstart-from-the-customer-portal).
