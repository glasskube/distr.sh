...
- **Image with tag**: `registry.example.com/my-app:v1.2.0`
- **Image with digest**: `registry.example.com/my-app@sha256:abc123...`
...
- **Commercial registries** - JFrog Artifactory, Cloudsmith, [Distr](/blog/container-image-registry-comparison/)
...
While registries like [Docker Hub, Harbor, JFrog Artifactory, and cloud provider registries](/blog/container-image-registry-comparison/) work well for internal use, specialized platforms like [Distr](/blog/container-image-registry-comparison/) are designed specifically for software vendors distributing to external customers.
...
### Are container registries secure?
...
Costs vary widely. Docker Hub offers limited free public repositories. Cloud provider registries (ECR, ACR, GAR) charge based on storage ($0.10/GB/month typical) and bandwidth. Self-hosted registries have server/infrastructure costs but no per-GB fees. Enterprise registries like JFrog Artifactory have license fees. [Distr](/blog/container-image-registry-comparison/) offers free open-source and paid managed options.

### Can I run a registry on-premises or in an air-gapped environment?

Yes, self-hosted registries like Harbor, Distribution, and [Distr self-hosted](/blog/container-image-registry-comparison/) can run entirely on-premises or in [air-gapped](/glossary/air-gapped-meaning/) environments with no internet connectivity. This is common in regulated industries and high-security deployments.
...
Software vendors distributing commercial applications to external customers should use purpose-built registries like [Distr](/blog/container-image-registry-comparison/) that provide customer-specific access controls, usage analytics, license management, and support for self-managed and [air-gapped](/glossary/air-gapped-meaning/) customer deployments. Standard internal registries lack these customer-facing capabilities.
